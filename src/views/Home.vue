      ...
      <div class="row">
        ...
        <div class="column">
          <div class="flex-column">
            ...
            <Button size="small" disabled>Add Job +</Button>
          </div>
        </div>
      </div>
    ...
    <div class="right-side">
      ...
      <div class="row">
        <div class="column">
          ...
          <p>
            It is up to the individual keepers to set up their devops and infrastructure and create their own rules
            based on what job they deem profitable.
          </p>
          <p>
            Each time keepers perform such a job, they are rewarded in either ETH, tokens, or systems native token KP3R.
            The maximum amount of KP3R to receive is gasUsed + premium (configurable by governance).
          </p>
        </div>
        <div class="column">
          <div class="flex-column">
            ...
            <div>
              ...
              <p>
                ...
                you can call activate(). Once activated your lastJob timestamp will be set to the current block
                timestamp.
              </p>
            </div>
          </div>
...
export default {
  ...
  computed: {
    ...mapGetters('wallet', ['getWalletStatus', 'getIsWalletConnected']),
